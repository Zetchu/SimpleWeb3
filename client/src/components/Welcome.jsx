...
const Input = ({
  ...
  <input
    ...
    className="my-5 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none white-glassmorphism"
  />
);
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
            Send Crypto <br /> acorss za waurdooo!
          </h1>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w=11/12 text/base">
            Explore the crypto world. Buy and sell your shit here!
          </p>
          {!currentAccount && (
            <button
              type="button"
              ...
              className="
           flex flex-row justify-center items-center my-5 bg-[#2952e3] rounded-full cursor-pointer hover:bg-[#2546ba] "
            >
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`rounded-tr-2xl ${commonStyles}`}>ETh</div>
            <div className={`rounded-bl-2xl ${commonStyles}`}>Binance</div>
